...
<div className="not-prose my-12 flex justify-center">
  <StartProjectButton>Find your architect</StartProjectButton>
</div>
...
<div className="not-prose my-12">
  <div className="rounded-3xl bg-neutral-100 p-6 sm:p-10">
    ...
    <div className="mt-6">
      <StartProjectButton>Describe your project for free</StartProjectButton>
    </div>
  </div>
</div>
...
**With Hauss Paris, everything changes:** you complete a detailed questionnaire about your project, and we propose one or more pre-qualified architect profiles, available, and perfectly suited to your needs. You quickly meet the right professionals.
...
<div className="not-prose my-12 flex justify-center">
  <StartProjectButton>Ready to launch your project? Find your architect</StartProjectButton>
</div>
