...
export default function DisenoPersonalizadoService() {
  const t = useTranslations('CustomLayoutService')

  return (
    <AvailableLocalesProvider availableLocales={[...locales]} localeUrls={routes.customLayout}>
    <RootLayout>
      ...
      <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
        ...
        <Container className="mt-24">
          <GridList lgColumns={2}>
            <GridListItem title={t('gridList.kitchens.title')}>{t('gridList.kitchens.description')}</GridListItem>
            <GridListItem title={t('gridList.storage.title')}>{t('gridList.storage.description')}</GridListItem>
            <GridListItem title={t('gridList.workspace.title')}>{t('gridList.workspace.description')}</GridListItem>
            <GridListItem title={t('gridList.decorative.title')}>{t('gridList.decorative.description')}</GridListItem>
          </GridList>
        </Container>
      </div>
