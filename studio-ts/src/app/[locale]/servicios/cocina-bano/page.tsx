...
export default function CocinaBanoService() {
      ...
      <Container className="mt-24 space-y-24 [counter-reset:section] sm:mt-32 sm:space-y-32 lg:mt-40 lg:space-y-40">
          ...
          <div className="lg:flex lg:items-center lg:justify-end lg:gap-x-8 xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
                <StylizedImage src={imageCuisine}
                  alt="Cuisine équipée design à Paris" sizes="(min-width: 1024px) 41rem, 31rem" className="justify-center lg:justify-end" />
              </FadeIn>
            </div>
        ...
        <section className="group/section [counter-increment:section]">
          <div className="lg:flex lg:items-center lg:justify-start lg:gap-x-8 lg:group-even/section:justify-start xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
                <StylizedImage src={imageSalleDeBain}
                  alt="Salle de bain en marbre rénovée à Paris" shape={1} sizes="(min-width: 1024px) 41rem, 31rem" className="justify-center lg:justify-start" />
              </FadeIn>
            </div>
      ...
      <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
        ...
        <Container className="mt-24">
          <GridList lgColumns={2}>
            ...
            <GridListItem title={t('gridList.bathrooms.title')}>{t('gridList.bathrooms.description')}</GridListItem>
            <GridListItem title={t('gridList.equipment.title')}>{t('gridList.equipment.description')}</GridListItem>
            <GridListItem title={t('gridList.materials.title')}>{t('gridList.materials.description')}</GridListItem>
          </GridList>
        </Container>
      </div>
