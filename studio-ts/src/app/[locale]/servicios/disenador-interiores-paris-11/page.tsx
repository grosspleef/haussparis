...
import imageLaptop from '@/images/architecte-interieur-paris-11-bastille.jpg'
...
export default function DisenadorInterioresParis11Service() {
  const t = useTranslations('ArchitecteParis11Service')
  const params = useParams()
  const locale = (params?.locale as string) || 'en'

  const startUrl = (locale === 'en' ? '/en/start' : locale === 'fr' ? '/fr/demarrer' : locale === 'it' ? '/it/inizia' : locale === 'de' ? '/de/projekt-starten' : '/es/empezar') + '?arr=11'
  ...
  return (
    ...
    <RootLayout>
      ...
      <ArrondissementLinks current={11} />
      <ContactSection />
    </RootLayout>
