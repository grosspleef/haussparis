...
import imageLaptop from '@/images/architecte-interieur-paris-4-ile-saint-louis.jpg'
...
export default function DisenadorInterioresParis4Service() {
  const t = useTranslations('ArchitecteParis4Service')
  const params = useParams()
  const locale = (params?.locale as string) || 'en'

  const startUrl = (locale === 'en' ? '/en/start' : locale === 'fr' ? '/fr/demarrer' : locale === 'it' ? '/it/inizia' : locale === 'de' ? '/de/projekt-starten' : '/es/empezar') + '?arr=4'
  ...
  return (
    <AvailableLocalesProvider availableLocales={[...locales]} localeUrls={routes.architecteInterieurParis4}>
    <RootLayout>
      <ArrondissementSchema namespace="ArchitecteParis4Service" arrondissement={4} />
      <ArrondissementBreadcrumb arrondissement={4} />
