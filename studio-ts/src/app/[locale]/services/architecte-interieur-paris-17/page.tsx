...
import imageLaptop from '@/images/architecte-interieur-paris-17-batignolles.jpg'
...
export default function ArchitecteInterieurParis17Service() {
  const t = useTranslations('ArchitecteParis17Service')
