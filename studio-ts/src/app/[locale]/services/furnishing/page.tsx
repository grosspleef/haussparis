          ...
          <div className="lg:flex lg:items-center lg:justify-start lg:gap-x-8 lg:group-even/section:justify-start xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
                <StylizedImage
                  src={imageLaptop}
                  alt="Sélection de meubles par architecte d'intérieur"
                  shape={1}
                  sizes="(min-width: 1024px) 41rem, 31rem"
      ...
      <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
        ...
        <Container className="mt-24">
          <GridList lgColumns={2}>
            <GridListItem title={t('gridList.sourcing.title')}>
              {t('gridList.sourcing.description')}
            </GridListItem>
            <GridListItem title={t('gridList.negotiation.title')}>
              {t('gridList.negotiation.description')}
            </GridListItem>
            <GridListItem title={t('gridList.delivery.title')}>
              {t('gridList.delivery.description')}
            </GridListItem>
            <GridListItem title={t('gridList.installation.title')}>
              {t('gridList.installation.description')}
            </GridListItem>
          </GridList>
        </Container>
      </div>
