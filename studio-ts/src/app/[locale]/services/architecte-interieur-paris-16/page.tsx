...
import imageLaptop from '@/images/architecte-interieur-paris-16-auteuil.jpg'
...
export default function ArchitecteInterieurParis16Service() {
  const t = useTranslations('ArchitecteParis16Service')
  const params = useParams()
  const locale = (params?.locale as string) || 'en'

  const startUrl = (locale === 'en' ? '/en/start' : locale === 'fr' ? '/fr/demarrer' : locale === 'it' ? '/it/inizia' : locale === 'de' ? '/de/projekt-starten' : '/es/empezar') + '?arr=16'
  ...
  return (
    <AvailableLocalesProvider availableLocales={[...locales]} localeUrls={routes.architecteInterieurParis16}>
    <RootLayout>
      <ArrondissementSchema namespace="ArchitecteParis16Service" arrondissement={16} />
      <ArrondissementBreadcrumb arrondissement={16} />
      ...
      <ArrondissementLinks current={16} />
      <ContactSection />
    </RootLayout>
