...
import imageLaptop from '@/images/conseil-decoration-interieure-paris.jpg'
import imageWhiteboard from '@/images/amenagement-sur-mesure-paris-luxe.jpg'
import { RootLayout } from '@/components/RootLayout'
import { AvailableLocalesProvider } from '@/contexts/AvailableLocalesContext'
import { routes, locales } from '@/lib/routes'

export default function CustomLayoutService() {
    ...
    <RootLayout>
          ...
          <div className="lg:flex lg:items-center lg:justify-end lg:gap-x-8 xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
                <StylizedImage
                  src={imageWhiteboard}
                  alt="Aménagement sur mesure de luxe à Paris"
          ...
          <div className="lg:flex lg:items-center lg:justify-start lg:gap-x-8 lg:group-even/section:justify-start xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
                <StylizedImage
                  src={imageLaptop}
                  alt="Conseil en décoration intérieure à Paris"
                  shape={1}
                  sizes="(min-width: 1024px) 41rem, 31rem"
      ...
      <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
        ...
        <Container className="mt-24">
          <GridList lgColumns={2}>
            <GridListItem title={t('gridList.kitchens.title')}>
              {t('gridList.kitchens.description')}
            </GridListItem>
            <GridListItem title={t('gridList.storage.title')}>
              {t('gridList.storage.description')}
            </GridListItem>
            <GridListItem title={t('gridList.workspace.title')}>
              {t('gridList.workspace.description')}
            </GridListItem>
            <GridListItem title={t('gridList.decorative.title')}>
              {t('gridList.decorative.description')}
            </GridListItem>
          </GridList>
        </Container>
      </div>
      ...
      <Container className="mt-24 sm:mt-32 lg:mt-40">
        <StatList>
          ...
          <StatListItem value="5 ans" label={t('stats.warranty')} />
        </StatList>
      </Container>
