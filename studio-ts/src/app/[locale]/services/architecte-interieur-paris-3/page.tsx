...
import imageLaptop from '@/images/architecte-interieur-paris-3-marais.jpg'
...
export default function ArchitecteInterieurParis3Service() {
  const t = useTranslations('ArchitecteParis3Service')
  const params = useParams()
  const locale = (params?.locale as string) || 'en'

  const startUrl = (locale === 'en' ? '/en/start' : locale === 'fr' ? '/fr/demarrer' : locale === 'it' ? '/it/inizia' : locale === 'de' ? '/de/projekt-starten' : '/es/empezar') + '?arr=3'
  ...
  return (
    <AvailableLocalesProvider availableLocales={[...locales]} localeUrls={routes.architecteInterieurParis3}>
    <RootLayout>
      <ArrondissementSchema namespace="ArchitecteParis3Service" arrondissement={3} />
      <ArrondissementBreadcrumb arrondissement={3} />
