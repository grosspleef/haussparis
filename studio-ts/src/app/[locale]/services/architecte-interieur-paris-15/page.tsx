...
import imageLaptop from '@/images/architecte-interieur-paris-15-moderne.jpg'
...
export default function ArchitecteInterieurParis15Service() {
  const t = useTranslations('ArchitecteParis15Service')
  const params = useParams()
  const locale = (params?.locale as string) || 'en'

  const startUrl = (locale === 'en' ? '/en/start' : locale === 'fr' ? '/fr/demarrer' : locale === 'it' ? '/it/inizia' : locale === 'de' ? '/de/projekt-starten' : '/es/empezar') + '?arr=15'
  ...
  return (
    <AvailableLocalesProvider availableLocales={[...locales]} localeUrls={routes.architecteInterieurParis15}>
    <RootLayout>
      <ArrondissementSchema namespace="ArchitecteParis15Service" arrondissement={15} />
      <ArrondissementBreadcrumb arrondissement={15} />
      ...
      <ArrondissementLinks current={15} />
      <ContactSection />
    </RootLayout>
