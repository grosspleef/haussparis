...
import imageLaptop from '@/images/ameublement-appartement-parisien.jpg'
import imageWhiteboard from '@/images/projet-renovation-complete-paris.jpg'
    ...
    <RootLayout>
      ...
      <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
        ...
        <Container className="mt-24">
          <GridList lgColumns={2}>
            ...
            <GridListItem title={t('gridList.preparation.title')}>
              {t('gridList.preparation.description')}
            </GridListItem>
          </GridList>
        </Container>
      </div>
      ...
      <Container className="mt-24 sm:mt-32 lg:mt-40">
        <StatList>
          ...
          <StatListItem value="2x" label={t('stats.visits')} />
          <StatListItem value="-50%" label={t('stats.delay')} />
        </StatList>
      </Container>
