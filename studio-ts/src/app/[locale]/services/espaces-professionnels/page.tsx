  ...
  return (
    <RootLayout>
      ...
      <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
        ...
        <Container className="mt-24">
          <GridList lgColumns={2}>
            <GridListItem title={t('gridList.planning.title')}>
              {t('gridList.planning.description')}
            </GridListItem>
            <GridListItem title={t('gridList.design.title')}>
              {t('gridList.design.description')}
            </GridListItem>
            <GridListItem title={t('gridList.ergonomics.title')}>
              {t('gridList.ergonomics.description')}
            </GridListItem>
      ...
      <Container className="mt-24 sm:mt-32 lg:mt-40">
        <StatList>
          <StatListItem value="+40%" label={t('stats.productivity')} />
          <StatListItem value="100+" label={t('stats.offices')} />
          <StatListItem value="95%" label={t('stats.satisfaction')} />
        </StatList>
      </Container>
