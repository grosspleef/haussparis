...
export default function ArchitecteInterieurParisService() {
  ...
  const decoratorUrl = locale === 'en' ? '/services/interior-decorator-paris' : '/services/decorateur-interieur-paris'
  ...
  return (
    ...
    <RootLayout>
      ...
      <Container className="mt-24 space-y-24 [counter-reset:section] sm:mt-32 sm:space-y-32 lg:mt-40 lg:space-y-40">
        {/* Section 1: Votre projet parisien entre de bonnes mains */}
          ...
          <div className="lg:flex lg:items-center lg:justify-end lg:gap-x-8 xl:gap-x-20">
            ...
            <div className="mt-12 lg:mt-0 lg:w-148 lg:flex-none">
              <FadeIn>
                ...
                <div className="mt-8">
                  <Link
                    href="/fr/blog/tarif-architecte-interieur-paris"
        ...
        {/* Section 2: Pourquoi faire appel à un architecte d'intérieur à Paris ? */}
        <section className="group/section [counter-increment:section]">
        ...
        {/* Section 3: Notre réseau d'architectes d'intérieur à Paris */}
        <section className="group/section [counter-increment:section]">
          <div className="lg:flex lg:items-center lg:justify-end lg:gap-x-8 xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
        ...
        {/* Section 4: Comment se déroule votre projet ? */}
        <section className="group/section [counter-increment:section]">
          <div className="lg:flex lg:items-center lg:justify-start lg:gap-x-8 lg:group-even/section:justify-start xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
      ...
      <Container className="mt-16">
        <FadeIn>
          <div className="rounded-3xl border border-neutral-200 p-8">
            ...
            <p className="mt-4 text-sm text-neutral-600">
              Découvrez notre guide complet sur la rénovation d&apos;appartement à Paris avec
              conseils pratiques, budgets détaillés et exemples de projets.
            </p>
            <div className="mt-6">
              <Link
                href="/fr/blog/renovation-appartement-paris-guide-complet"
                className="inline-flex items-center text-sm font-semibold text-neutral-950 hover:text-neutral-700"
              >
      ...
      {/* Cross-link to decorator service */}
      <Container className="mt-16">
        <FadeIn>
          <div className="rounded-3xl border border-neutral-200 p-8 bg-neutral-50">
            <h3 className="font-display text-lg font-semibold text-neutral-950">
              {t('decoratorLink.title')}
            </h3>
            <p className="mt-4 text-sm text-neutral-600">
              {t('decoratorLink.description')}
            </p>
            <div className="mt-6">
              <Link
                href={decoratorUrl}
