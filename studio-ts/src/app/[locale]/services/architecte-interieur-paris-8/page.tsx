...
import imageLaptop from '@/images/architecte-interieur-paris-8-champs-elysees.jpg'
...
export default function ArchitecteInterieurParis8Service() {
  const t = useTranslations('ArchitecteParis8Service')
  const params = useParams()
  const locale = (params?.locale as string) || 'en'

  const startUrl = (locale === 'en' ? '/en/start' : locale === 'fr' ? '/fr/demarrer' : locale === 'it' ? '/it/inizia' : locale === 'de' ? '/de/projekt-starten' : '/es/empezar') + '?arr=8'
  ...
  return (
    ...
    <RootLayout>
      <ArrondissementSchema namespace="ArchitecteParis8Service" arrondissement={8} />
      <ArrondissementBreadcrumb arrondissement={8} />
