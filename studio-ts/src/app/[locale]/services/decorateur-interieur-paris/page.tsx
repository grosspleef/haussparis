...
import imageSection1 from '@/images/decoration-salon-contemporain-paris.jpg'
import imageSection2 from '@/images/choix-mobilier-design-paris.jpg'
import imageSection3 from '@/images/conseil-decoration-interieure-paris.jpg'
import imageSection4 from '@/images/consultation-design-moodboard.jpg'
  ...
  return (
    ...
    <RootLayout>
      ...
      <Container className="mt-24 space-y-24 [counter-reset:section] sm:mt-32 sm:space-y-32 lg:mt-40 lg:space-y-40">
        {/* Section 1: Décoration d'intérieur : une transformation rapide et accessible */}
        ...
        {/* Section 2: Pour qui ? Les situations idéales pour un décorateur */}
        <section className="group/section [counter-increment:section]">
        ...
        {/* Section 3: Notre réseau de décorateurs d'intérieur à Paris */}
        <section className="group/section [counter-increment:section]">
          <div className="lg:flex lg:items-center lg:justify-end lg:gap-x-8 xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
        ...
        {/* Section 4: Comment se déroule votre projet de décoration ? */}
        <section className="group/section [counter-increment:section]">
          <div className="lg:flex lg:items-center lg:justify-start lg:gap-x-8 lg:group-even/section:justify-start xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
      ...
      <Container className="mt-24 sm:mt-32 lg:mt-40">
        <StatList>
          <StatListItem value="60+" label={t('stats.international')} />
          <StatListItem value="15+" label={t('stats.network')} />
          <StatListItem value="5 sem." label={t('stats.satisfaction')} />
        </StatList>
      </Container>
        ...
        <FadeIn>
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-3xl border border-neutral-200 p-8">
              ...
              <dl className="mt-8 space-y-4">
                ...
                <div className="flex justify-between border-b border-neutral-100 pb-4">
                  <dt className="text-sm text-neutral-600">{t('pricing.fees.concept.label')}</dt>
                  <dd className="text-sm font-semibold text-neutral-950">
                    {t('pricing.fees.concept.price')}
                  </dd>
                </div>
                <div className="flex justify-between border-b border-neutral-100 pb-4">
            ...
            <div className="rounded-3xl border border-neutral-200 p-8">
              <h3 className="font-display text-xl font-semibold text-neutral-950">
                {t('pricing.furniture.title')}
              </h3>
              <dl className="mt-8 space-y-4">
                <div className="flex justify-between border-b border-neutral-100 pb-4">
                  <dt className="text-sm text-neutral-600">
                    {t('pricing.furniture.refresh.label')}
                  </dt>
                  <dd className="text-sm font-semibold text-neutral-950">
                    {t('pricing.furniture.refresh.price')}
                  </dd>
                </div>
                <div className="flex justify-between border-b border-neutral-100 pb-4">
                  <dt className="text-sm text-neutral-600">
                    {t('pricing.furniture.partial.label')}
                  </dt>
                  <dd className="text-sm font-semibold text-neutral-950">
                    {t('pricing.furniture.partial.price')}
                  </dd>
                </div>
                <div className="flex justify-between border-b border-neutral-100 pb-4">
                  <dt className="text-sm text-neutral-600">
                    {t('pricing.furniture.complete.label')}
                  </dt>
                  <dd className="text-sm font-semibold text-neutral-950">
                    {t('pricing.furniture.complete.price')}
                  </dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-sm text-neutral-600">{t('pricing.furniture.highend.label')}</dt>
                  <dd className="text-sm font-semibold text-neutral-950">
                    {t('pricing.furniture.highend.price')}
                  </dd>
                </div>
              </dl>
            </div>
          ...
          <div className="mt-8 rounded-3xl bg-neutral-50 p-8">
            ...
            <ul className="mt-4 space-y-2 text-sm text-neutral-600">
              <li>• {t('pricing.example.furniture')}</li>
          ...
          <div className="mt-16">
            ...
            <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
              <div className="rounded-3xl border-2 border-neutral-950 bg-neutral-50 p-8">
                <h4 className="font-display text-lg font-semibold text-neutral-950">
                  {t('pricing.comparison.decorator.title')}
                </h4>
                <dl className="mt-6 space-y-3 text-sm">
                  <div>
                    <dt className="font-semibold text-neutral-950">Périmètre :</dt>
                    <dd className="text-neutral-600">{t('pricing.comparison.decorator.scope')}</dd>
                  </div>
                  <div>
                    <dt className="font-semibold text-neutral-950">Travaux :</dt>
                    <dd className="text-neutral-600">{t('pricing.comparison.decorator.works')}</dd>
                  </div>
                  <div>
                    <dt className="font-semibold text-neutral-950">Budget :</dt>
                    <dd className="text-neutral-600">{t('pricing.comparison.decorator.budget')}</dd>
                  </div>
                  <div>
                    <dt className="font-semibold text-neutral-950">Délai :</dt>
                    <dd className="text-neutral-600">{t('pricing.comparison.decorator.timeline')}</dd>
                  </div>
                  <div>
                    <dt className="font-semibold text-neutral-950">Idéal pour :</dt>
                    <dd className="text-neutral-600">{t('pricing.comparison.decorator.ideal')}</dd>
                  </div>
                </dl>
              </div>
              ...
              <div className="rounded-3xl border border-neutral-200 p-8">
                <h4 className="font-display text-lg font-semibold text-neutral-950">
                  {t('pricing.comparison.architect.title')}
                </h4>
                <dl className="mt-6 space-y-3 text-sm">
                  <div>
                    <dt className="font-semibold text-neutral-950">Périmètre :</dt>
                    <dd className="text-neutral-600">{t('pricing.comparison.architect.scope')}</dd>
                  </div>
                  <div>
                    <dt className="font-semibold text-neutral-950">Travaux :</dt>
                    <dd className="text-neutral-600">{t('pricing.comparison.architect.works')}</dd>
                  </div>
                  <div>
                    <dt className="font-semibold text-neutral-950">Budget :</dt>
                    <dd className="text-neutral-600">{t('pricing.comparison.architect.budget')}</dd>
                  </div>
                  <div>
                    <dt className="font-semibold text-neutral-950">Délai :</dt>
                    <dd className="text-neutral-600">{t('pricing.comparison.architect.timeline')}</dd>
                  </div>
                  <div>
                    <dt className="font-semibold text-neutral-950">Idéal pour :</dt>
                    <dd className="text-neutral-600">{t('pricing.comparison.architect.ideal')}</dd>
                  </div>
                </dl>
                <div className="mt-6">
                  <Link
                    href="/fr/services/architecte-interieur-paris"
                    className="inline-flex items-center text-sm font-semibold text-neutral-950 hover:text-neutral-700"
                  >
                    {t('pricing.comparison.architect.link')}
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-3xl border border-neutral-200 p-8">
              <h3 className="font-display text-lg font-semibold text-neutral-950">
                {t('projects.airbnb.title')}
              </h3>
              <p className="mt-4 text-sm text-neutral-600">
                {t('projects.airbnb.description')}
              </p>
            </div>
            <div className="rounded-3xl border border-neutral-200 p-8">
              <h3 className="font-display text-lg font-semibold text-neutral-950">
            ...
            <div className="rounded-3xl border border-neutral-200 p-8">
              <h3 className="font-display text-lg font-semibold text-neutral-950">
                {t('projects.staging.title')}
              </h3>
              <p className="mt-4 text-sm text-neutral-600">
                {t('projects.staging.description')}
              </p>
            </div>
            <div className="rounded-3xl border border-neutral-200 p-8">
              <h3 className="font-display text-lg font-semibold text-neutral-950">
                {t('projects.refresh.title')}
              </h3>
              <p className="mt-4 text-sm text-neutral-600">
                {t('projects.refresh.description')}
              </p>
            </div>
            <div className="rounded-3xl border border-neutral-200 p-8">
              <h3 className="font-display text-lg font-semibold text-neutral-950">
                {t('projects.expat.title')}
              </h3>
              <p className="mt-4 text-sm text-neutral-600">
                {t('projects.expat.description')}
              </p>
            </div>
            <div className="rounded-3xl border border-neutral-200 p-8">
              <h3 className="font-display text-lg font-semibold text-neutral-950">
      ...
      {/* Cross-link to architect service */}
      <Container className="mt-16">
        <FadeIn>
          <div className="rounded-3xl border border-neutral-200 p-8 bg-neutral-50">
            <h3 className="font-display text-lg font-semibold text-neutral-950">
              {t('architectLink.title')}
            </h3>
            <p className="mt-4 text-sm text-neutral-600">
              {t('architectLink.description')}
            </p>
            <div className="mt-6">
              <Link
                href={architectUrl}
