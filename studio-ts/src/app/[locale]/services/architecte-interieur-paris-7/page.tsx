...
import imageLaptop from '@/images/architecte-interieur-paris-7-invalides.jpg'
...
export default function ArchitecteInterieurParis7Service() {
  const t = useTranslations('ArchitecteParis7Service')
  const params = useParams()
  const locale = (params?.locale as string) || 'en'

  const startUrl = (locale === 'en' ? '/en/start' : locale === 'fr' ? '/fr/demarrer' : locale === 'it' ? '/it/inizia' : locale === 'de' ? '/de/projekt-starten' : '/es/empezar') + '?arr=7'
  ...
  return (
    <AvailableLocalesProvider availableLocales={[...locales]} localeUrls={routes.architecteInterieurParis7}>
    <RootLayout>
      <ArrondissementSchema namespace="ArchitecteParis7Service" arrondissement={7} />
      <ArrondissementBreadcrumb arrondissement={7} />
