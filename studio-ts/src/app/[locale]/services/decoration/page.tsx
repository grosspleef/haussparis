      ...
      <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
        ...
        <Container className="mt-24">
          <GridList lgColumns={2}>
            <GridListItem title={t('gridList.palette.title')}>
              {t('gridList.palette.description')}
            </GridListItem>
            ...
            <GridListItem title={t('gridList.accessories.title')}>
              {t('gridList.accessories.description')}
            </GridListItem>
          </GridList>
        </Container>
      </div>
