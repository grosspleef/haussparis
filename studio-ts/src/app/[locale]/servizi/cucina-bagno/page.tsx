    ...
    <RootLayout>
          ...
          <div className="lg:flex lg:items-center lg:justify-end lg:gap-x-8 xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
                <StylizedImage
                  src={imageWhiteboard}
                  alt="Cuisine équipée design à Paris"
          ...
          <div className="lg:flex lg:items-center lg:justify-start lg:gap-x-8 lg:group-even/section:justify-start xl:gap-x-20">
            <div className="flex justify-center">
              <FadeIn className="w-135 flex-none lg:w-180">
                <StylizedImage
                  src={imageLaptop}
                  alt="Salle de bain en marbre rénovée à Paris"
                  shape={1}
                  sizes="(min-width: 1024px) 41rem, 31rem"
      ...
      <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
        ...
        <Container className="mt-24">
          <GridList lgColumns={2}>
            ...
            <GridListItem title={t('gridList.bathrooms.title')}>
              {t('gridList.bathrooms.description')}
            </GridListItem>
            <GridListItem title={t('gridList.equipment.title')}>
              {t('gridList.equipment.description')}
            </GridListItem>
            <GridListItem title={t('gridList.materials.title')}>
              {t('gridList.materials.description')}
            </GridListItem>
          </GridList>
        </Container>
      </div>
      ...
      <Container className="mt-24 sm:mt-32 lg:mt-40">
        <StatList>
          ...
          <StatListItem value="10 anni" label={t('stats.warranty')} />
        </StatList>
      </Container>
