  ...
  return (
    <RootLayout>
      ...
      <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
        ...
        <Container className="mt-24">
          <GridList lgColumns={2}>
            <GridListItem title={t('gridList.boutiques.title')}>
              {t('gridList.boutiques.description')}
            </GridListItem>
            <GridListItem title={t('gridList.showrooms.title')}>
              {t('gridList.showrooms.description')}
            </GridListItem>
            <GridListItem title={t('gridList.merchandising.title')}>
              {t('gridList.merchandising.description')}
            </GridListItem>
            <GridListItem title={t('gridList.identity.title')}>
              {t('gridList.identity.description')}
            </GridListItem>
          </GridList>
        </Container>
      </div>
      ...
      <Container className="mt-24 sm:mt-32 lg:mt-40">
        <StatList>
          <StatListItem value="+25%" label={t('stats.revenue')} />
          <StatListItem value="150+" label={t('stats.spaces')} />
