...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  const { locale } = params
  const t = await getTranslations({ locale, namespace: 'ArchitecteParis11Service.metadata' })
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: `${baseUrl}/og-image.jpg`, width: 1200, height: 630, alt: `Hauss Paris - ${t('title')}` }],
    },
    twitter: {
