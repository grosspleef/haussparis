...
export default function EinrichtungService() {
    ...
    <RootLayout>
      ...
      <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
        ...
        <Container className="mt-24">
          <GridList lgColumns={2}>
            <GridListItem title={t('gridList.sourcing.title')}>{t('gridList.sourcing.description')}</GridListItem>
            <GridListItem title={t('gridList.negotiation.title')}>{t('gridList.negotiation.description')}</GridListItem>
            <GridListItem title={t('gridList.delivery.title')}>{t('gridList.delivery.description')}</GridListItem>
            <GridListItem title={t('gridList.installation.title')}>{t('gridList.installation.description')}</GridListItem>
          </GridList>
        </Container>
      </div>
      ...
      <Container className="mt-24 sm:mt-32 lg:mt-40">
        <StatList>
          ...
          <StatListItem value="A-Z" label={t('stats.tracking')} />
        </StatList>
      </Container>
