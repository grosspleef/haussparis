...
const blogArticlesByLocale: Record<string, RouteConfig[]> = {
  fr: [
    ...
    { path: '/blog/renovation-cuisine-paris-guide-complet', priority: 0.8, changeFrequency: 'monthly' },
  ...
  en: [
    { path: '/blog/kitchen-renovation-paris-complete-guide', priority: 0.8, changeFrequency: 'monthly' },
